...
var phoneNumber = '5712713232'; // Replace the #s with the String representation of the phone number, including country code (1 for USA)

// var phoneNumber = '##########'; // Replace the #s with the String representation of the phone number, including country code (1 for USA)

var message = 'Tessel Test Message!';
